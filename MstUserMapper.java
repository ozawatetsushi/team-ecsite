...
public interface MstUserMapper {
	 ...
	 * @return 登録件数
	 */
	@Insert("INSERT INTO mst_user (user_name, family_name, first_name, family_name_kana, first_name_kana, gender, password) VALUES (#{userName}, #{familyName}, #{firstName}, #{familyNameKana}, #{firstNameKana},  #{gender},  #{password})")
